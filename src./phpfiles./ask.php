...
>>>>>>> 9b7c28ed1be4a59ef5c6396a98f5ef0734b1cc01
           <h1><input type='title' name="title" placeholder='Title' class='input-line full-width' size="70" style="height:25px"></h1>
...
<<<<<<< HEAD
            ...
            $d = date('Y-m-j');
            $t = $_POST["title"];
            $sql = "INSERT INTO `table_ask2` (`PSEUDO`,`QUESTION` ,`DATE`,`TITLE`)
             VALUES ('$pseudo','$q','$d','$t')";
=======
            $pseudo = $_SESSION["PSEUDO"];
            $q = $_POST["question"];
            $d = date('Y-m-j');
            $sql = "INSERT INTO `table_ask2` (`PSEUDO`,`QUESTION` ,`DATE`)
             VALUES ('$pseudo','$q','$d')";
>>>>>>> 9b7c28ed1be4a59ef5c6396a98f5ef0734b1cc01
            $result = $conn->query($sql);// On lance la requête
            if ($result === TRUE) {
                echo "New record created successfully";
                header('Location: mypage.php?msg2=1');
